        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-serif font-bold text-[var(--color-foreground)] leading-[1.1] mb-6">
              ...
              <span className="block text-[var(--color-gold)]">em movimento.</span>
            </h1>

            {/* Description */}
            <p className="text-lg lg:text-xl text-[var(--color-muted)] leading-relaxed max-w-lg mb-10">
              {siteData.description} Levamos experiências transformadoras para comunidades em todo o Brasil.
            </p>
          ...
          >
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden bg-[var(--color-warm-dark)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-[var(--color-foreground)]/20">
                <div className="text-center">
                  ...
                  >
                    <Play size={32} className="text-[var(--color-foreground)] ml-1 group-hover:text-[var(--color-gold)] transition-colors" />
                  </motion.div>
                  <p className="mt-4 text-sm text-[var(--color-background)] font-medium">Assista ao vídeo institucional</p>
                </div>
              </div>
            ...
            <motion.div
              ...
              className="absolute -left-8 bottom-20 bg-[var(--color-card)] rounded-2xl p-5 shadow-xl border border-[var(--color-border)]"
            >
              <p className="text-3xl font-serif font-bold text-[var(--color-foreground)]">50+</p>
              <p className="text-sm text-[var(--color-muted)]">Municípios atendidos</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute -right-4 top-20 bg-[var(--color-card)] rounded-2xl p-5 shadow-xl border border-[var(--color-border)]"
            >
              <p className="text-3xl font-serif font-bold text-[var(--color-gold)]">10k+</p>
              <p className="text-sm text-[var(--color-muted)]">Vidas impactadas</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
